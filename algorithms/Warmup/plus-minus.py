...
#   are 36=0.50000036=0.500000, 26=0.33333326=0.333333 and
...
print '{0:.6f}'.format(round(z/float(n), 6))
print '{0:.6f}'.format(round(y/float(n), 6))
print '{0:.6f}'.format(round(x/float(n), 6))
